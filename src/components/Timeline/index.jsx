...
export const TimeLine = () => {
   ...
   <VerticalTimeline>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">June 1975</h4>
         <h3 className="vertical-timeline-element-title">The Jackson 5 moves to Epic Records.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">October 24, 1978</h4>
         <h3 className="vertical-timeline-element-title">Jackson stars as the Scarecrow in the movie, The Wiz.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">August 10, 1979</h4>
         <h3 className="vertical-timeline-element-title">Jackson releases his solo album, Off the Wall.</h3>  
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">November 30, 1982</h4>
         <h3 className="vertical-timeline-element-title">Jackson releases Thriller.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">March 25, 1983</h4>
         <h3 className="vertical-timeline-element-title">Jackson participates in the live Motown 25 special.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">December 2, 1983</h4>
         <h3 className="vertical-timeline-element-title">Jackson releases the Thriller music video.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">March 8, 1985</h4>
         <h3 className="vertical-timeline-element-title">Jackson works with Lionel Richie to co-release We Are the World.</h3>  
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">March 1988</h4>
         <h3 className="vertical-timeline-element-title">Jackson purchases the land to build Neverland Ranch.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">August 21, 1993</h4>
         <h3 className="vertical-timeline-element-title">Police raid the Neverland Ranch.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">May 26, 1994</h4>
         <h3 className="vertical-timeline-element-title">Jackson marries Lisa Marie Presley.</h3>
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">January 31, 2005</h4>
         <h3 className="vertical-timeline-element-title">Jackson's second child molestation trial begins.</h3>  
         <p>
      ...
      <VerticalTimelineElement
         ...
         iconStyle={{ background: 'rgb(81, 2, 3)', color: 'rgb(34, 50, 3)' }}
      >
         <h4 className="vertical-timeline-element-subtitle">June 25, 2009</h4>
         <h3 className="vertical-timeline-element-title">Jackson dies.</h3>
         <p>
